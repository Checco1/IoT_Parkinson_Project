...
class SFSimulator():
    def __init__(self, dbsID, topic_activation, topic_update, broker, port):
        ...
        self.client = MyMQTT("SF2",broker,port,self)
        self.sf_activation = False
        self.t_activation = time.time()
        self.message={"bn": "patient2/sf2",
                "e":
                    [
                        {
    ...
    def notify(self, topic, msg):
        ...
        if self.sf_activation == True:
            print("SF for patient 2 already activated!")
        else:
...
if __name__ == "__main__":
    ...
    #Initialization
    print("The actuator SoundFeedback2 is not active")
    ...
    #Start the simulator
    soundfeedback1=SFSimulator("soundfeedback2",  topic_activation, topic_update, broker, port)
    ...
    while True:
        ...
        if soundfeedback1.sf_activation==True and abs(soundfeedback1.t_activation-time.time())>5:
            ...
            print("The SF2 has been deactivated!")
            #this condition simulate the deactivation of the SF after 5 seconds